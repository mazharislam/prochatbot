...
**For production use:** Review the [SECURITY.md](SECURITY.md) audit and adapt controls 
to your specific compliance requirements (SOC 2, GDPR, etc.). Security is contextual—what 
works here may need adjustment for your threat model and regulatory environment.
